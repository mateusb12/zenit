...
export function DiagnosticSection() {
  ...
  return (
    <section id="diagnostico" className={`${sectionClass} bg-[#f5f7fa]`}>
      <div className={`${containerClass} grid grid-cols-[0.9fr_1.1fr] items-stretch gap-7 max-[980px]:grid-cols-1`}>
        <aside className="h-full rounded-3xl bg-[#0e2a47] p-8 text-white shadow-[0_18px_46px_rgba(7,26,46,0.14)] max-[680px]:p-[22px]">
          ...
          <p className="mt-4 leading-[1.8] text-white/75">
            Use o formulário para uma análise inicial mais organizada. Se
            preferir contato direto, fale pelo WhatsApp.
          </p>
        ...
        >
          ...
          <p className="mt-2 leading-[1.75] text-[#4b5563]">
            Preencha os dados principais para direcionarmos o primeiro contato
          ...
          <div className="mt-6 grid gap-2.5">
            ...
            <span className="max-w-[420px] text-sm leading-[1.55] text-[#647184]">
              Usaremos os dados para direcionar o primeiro contato.
            </span>
          </div>
        </form>
      </div>
